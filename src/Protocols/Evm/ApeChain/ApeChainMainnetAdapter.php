...
{
    public function name(): string { return 'ApeChain'; }
    public function network(): string { return 'apechain'; }
    public function chainId(): int { return 33139; }
    public function defaultRpc(): ?string { return 'https://rpc.apechain.com'; }
