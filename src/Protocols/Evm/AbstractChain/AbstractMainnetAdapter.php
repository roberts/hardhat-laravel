...
{
    public function name(): string { return 'Abstract'; }
    public function network(): string { return 'abstract'; }
    public function chainId(): int { return 2741; }
    public function defaultRpc(): ?string { return 'https://api.mainnet.abs.xyz'; }
